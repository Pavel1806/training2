...
namespace DAL.Context
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<CreditCardsDetails> CreditCardsDetails { get; set; }
        ...
        //    //                optionsBuilder.UseSqlServer("Data Source=DESKTOP-5V2J771\\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");
        //    //            }
        //}
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CreditCardsDetails>(entity =>
            {
                entity.HasIndex(e => e.EmployeeId);

                entity.HasOne(d => d.Employee)
                    .WithMany(p => p.CreditCardsDetails)
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.Property(e => e.DateOfFoundation).HasDefaultValueSql("('0001-01-01T00:00:00.0000000')");
